...
const signup = async (body) => {
  ...
  try {
    ...
    const res = await client.query('INSERT INTO users(email, password, country, language, firstname, lastname, lastlogin) VALUES($1, $2, $3, $4, $5, $6, $7)', dbArr)
...
const login = async (body) => {
  ...
  try {
    ...
    const res = await client.query('SELECT "password", email, userid FROM users WHERE email = $1', email)
